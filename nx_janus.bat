...
set JE_BASE_RELEASE_VERSION=v12
set JE_RELEASE_VERSION=v12
...
set CUSTOMER_LIST_DIR=H:\Products\NXStartup\
...
DATE /T > H:\Products\NXStartup\NXStartup.log
TIME /T >> H:\Products\NXStartup\NXStartup.log
echo CUSTOMER %CUSTOMER% >> H:\Products\NXStartup\NXStartup.log 
H:\Products\NXStartup\startup\modify.men >> H:\Products\NXStartup\NXStartup.log
...
echo UGII_LICENSE_FILE %UGII_LICENSE_FILE% >> H:\Products\NXStartup\NXStartup.log 
) ELSE (
echo SPLM_LICENSE_SERVER %SPLM_LICENSE_SERVER% >> H:\Products\NXStartup\NXStartup.log 
)
...
echo JE_LICENSE_FILE %JE_LICENSE_FILE% >> H:\Products\NXStartup\NXStartup.log
GOTO ENDE
